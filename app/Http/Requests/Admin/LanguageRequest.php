...
class LanguageRequest extends FormRequest
{
    ...
    return [
        ...
        'label' => 'required|min:2|max:64|regex:/^[a-z0-9áéíóúàèìòùäëïöüñ\s]+$/i',
    ];
    }
    ...
    return [
        ...
        'label.min' => 'El mínimo de caracteres permitidos para el nombre son 2',
        'label.regex' => 'Sólo se aceptan letras para el nombre',
    ];
    }
}